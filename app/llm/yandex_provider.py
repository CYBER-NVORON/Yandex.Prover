...
- не считай claims номера страниц, элементы титульного листа, класс, год, ФИО, пункты содержания, список литературы, подписи приложений и заголовки разделов;
- извлекай claims только из основного текста, введения, практической части и заключения;
...
- strengths, weaknesses, risks, claims, recommendations и audience_questions должны быть конкретными.
